...
void main() {
  group('TaskManagementScreen Integration Tests', () {
    ...
    testWidgets('shows no routine loaded initially', (tester) async {
      ...
      // Both left and right columns show the same empty state
    ...
    testWidgets('displays right column UI', (tester) async {
      final bloc = RoutineBloc();
      ...
      // Load sample data to populate right column UI
      bloc.add(const LoadSampleRoutine());
      await tester.pumpAndSettle();
