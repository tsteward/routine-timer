...
class AuthBloc extends Bloc<AuthEvent, AuthBlocState> {
  ...
  Future<void> _onSignUpWithEmailPassword(
    ...
    final error = await _authService.signUpWithEmailPassword(
      email: event.email,
  ...
  Future<void> _onSignInWithEmailPassword(
    ...
    final error = await _authService.signInWithEmailPassword(
      email: event.email,
      password: event.password,
    );
  ...
  Future<void> _onSendPasswordReset(
    ...
    final error = await _authService.sendPasswordResetEmail(event.email);
