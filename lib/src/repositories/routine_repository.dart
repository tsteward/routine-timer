...
class RoutineRepository {
  ...
  /// Lazy initialization of AuthService instance
  ...
  DocumentReference<Map<String, dynamic>>? get _userRoutineDoc {
    final userId = _authServiceInstance.currentUserId;
    if (userId == null) return null;

    return _firestoreInstance.collection(_routinesCollection).doc(userId);
  }
